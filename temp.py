...
MANUAL_GAIN = 1.0  # only used if VOLTAGE_MODE = 'MANUAL'
...
class RedPitaya:
    ...
    def __init__(self, output_dir='test_data', voltage_mode='LV', manual_gain=1.0):
        ...
        # start continuous rolling mode acquisition
    ...
    def capture_voltage(self):
        """Grab new voltage data from continuous buffer"""
    ...
    def run(self, params):
        ...
        print(f"Recording started at: {start_time_str}")
