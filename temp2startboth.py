...
# ============================================================
# OVERVIEW PLOT  (matplotlib, saved as PNG)
# ============================================================
...
# Sweep direction mask from DC derivative
_dc_diff = np.gradient(dc_V)
_fwd = _dc_diff >= 0
_rev = ~_fwd

# R vs DC raw -- sweep coloured dots
...
# Theta vs DC raw -- sweep coloured dots
...
# ============================================================
# CYCLE-AVERAGED ACCV PLOTS  (interactive Plotly)
# ============================================================
# Saves an interactive HTML + optional PNG next to the data.
# Requires:  pip install plotly
# For PNG:   pip install kaleido
try:
    from accv_cycle_average import plot_accv_cycle_averaged
    accv_fig = plot_accv_cycle_averaged(
        dc_v          = dc_V,
        li_R          = li_R,
        li_Theta      = li_Theta,
    ...
    if accv_fig is not None:
        accv_fig.show()   # opens interactive Plotly figure in browser
except ImportError:
...
# ============================================================
plt.show()   # show the matplotlib overview figure
