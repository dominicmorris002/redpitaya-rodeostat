...
class RedPitaya:
    ...
    def __init__(self, output_dir='test_data', voltage_mode='LV', manual_gain=1.0):
        self.rp = Pyrpl(config='dc_monitor_config5', hostname='rp-f0909c.local')
