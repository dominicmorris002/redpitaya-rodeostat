...
if REDPITAYA_INPUT_MODE.upper() == 'LV':
    ...
    PYRPL_SCOPE_GAIN = 0.082336592  # PyRPL correction for LV
    ...
    PYRPL_SCOPE_GAIN = 11.7  # PyRPL correction for HV
    OTHER_GAIN = 8.72854255  # Hardware calibration + other corrections
