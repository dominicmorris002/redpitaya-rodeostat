...
class scpi(object):
    ...
    def gen_get_settings(self, chan: int, siglab: bool = False) -> List[Optional[str]]:
        """
    ...
    def gen_get_burst_settings(self, chan: int) -> List[Optional[str]]:
        """
    ...
    def gen_get_sweep_settings(self, chan: int) -> List[Optional[str]]:
        """
    ...
    def acq_get_settings(self, siglab: bool = False, input4: bool = False) -> List[Optional[str]]:
        """
    ...
    def acq_get_trig_settings(self, siglab: bool = False) -> List[Optional[str]]:
        """
        Retrieves the standard acquisition settings from Red Pitaya, prints them in console and returns
        them as an array with the following sequence:
    ...
    def uart_get_settings(self) -> List[Optional[str]]:
        """
