...
Press Enter ONCE here to launch all three acquisitions simultaneously.
Then press Enter a SECOND time when both RPs are connected and the
Rodeostat is ready -- this fires the measurement start to all three
...
rodeostat_script = os.path.join(os.path.dirname(os.path.abspath(__file__)), "rodeostat_test.py")
