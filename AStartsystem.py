...
# Use non-interactive backend -- no windows, no popups, ever
import matplotlib
matplotlib.use('Agg')
...
# ============================================================
# READ ONLY RED PITAYA CSVs
# Rodeostat CSV is saved by RodeostatControl.py but ignored here
# ============================================================
try:
...
# ============================================================
# PLOT -- original 7-panel RP-only layout  (saved silently)
